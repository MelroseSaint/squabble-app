...
export const MatchList: React.FC<MatchListProps> = ({ matches, onSelectMatch, onDeleteMatch }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-black text-white p-4 overflow-y-auto relative animate-in fade-in">
      <h2 className="text-3xl font-heading font-bold text-squabble-red mb-6 uppercase tracking-wider animate-laser-pulse text-shadow-laser">Your Opponents</h2>
        ...
        <div className="flex flex-col gap-4">
           {matches.map((match) => (
             <div 
                ...
                className="flex items-center gap-4 p-3 rounded-xl bg-squabble-gray border border-transparent hover:border-squabble-red transition-all cursor-pointer active:scale-95 group animate-laser-pulse text-shadow-laser"
             >
